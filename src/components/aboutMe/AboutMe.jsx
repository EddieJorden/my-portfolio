		...
		<AboutMeDiv>
			<ComponentDiv>
				<div >
					...
					<ul>In high school I Quickly learned Windows admin scripting and a few other technologies to successfully create automations for software used by my peers.</ul>
